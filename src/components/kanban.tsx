...
export const KanbanBoardCardTextarea = forwardRef<HTMLTextAreaElement, ComponentProps<'textarea'>>(
  function KanbanBoardCardTextarea({ className, onChange, value, ...props }, externalReference) {
 ...
 */
export const KanbanBoardCardButton = forwardRef<HTMLDivElement, ComponentProps<'div'> & KanbanBoardCardButtonProps>(
  function KanbanBoardCardButton({ className, tooltip, ...props }, externalReference) {

...
interface CameraWallDialogProps {
  isOpen: boolean;
...
const CameraGrid: React.FC<CameraGridProps> = ({ cameraDevices }) => {
...
export const CameraWallDialog: React.FC<CameraWallDialogProps> = ({ 
  isOpen, 
  onOpenChange, 
  title, 
  cameraDevices 

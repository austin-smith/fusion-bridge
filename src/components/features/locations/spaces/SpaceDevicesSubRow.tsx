...
const DraggableDeviceItem: React.FC<DraggableDeviceItemProps> = ({ device, sourceSpaceId }) => {
...
export const SpaceDevicesSubRow: React.FC<SpaceDevicesSubRowProps> = ({ 
  ...
  const totalDeviceCount = assignedDevices.length;

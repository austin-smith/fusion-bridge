...
const deviceSchema = z.object({
  ...
  name: z.string().nullable().describe('Device name'),
  type: z.string().describe('Device type'),
  lastStateUpdate: z.string().nullable().describe('Last state update timestamp (ISO string)'),
  isOnline: z.boolean().describe('Device online status'),
  createdAt: z.string().describe('Creation timestamp (ISO string)'),
  updatedAt: z.string().describe('Last update timestamp (ISO string)'),
}).openapi('Device');

...
import { getLinearConfiguration, getResendConfiguration } from "@/data/repositories/service-configurations";
...
export default async function SystemSettingsPage() {
  ...
  const resendConfig = await getResendConfiguration();
  ...
  return (
    <div className="container py-6">
      ...
      <SystemSettingsContent
        ...
        initialResendConfig={resendConfig}
      />
    </div>
  );
} 
...
import { getDbPath, ensureDbDir } from '../../packages/shared/src/data/db/utils'; // Import helpers
...
export default defineConfig({
  schema: '../../packages/shared/src/data/db/schema.ts',
  out: '../../packages/shared/src/data/db/migrations',
  dialect: "sqlite",
  dbCredentials: {

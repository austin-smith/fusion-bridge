import { db, events as eventsTableSchema, devices as devicesTableSchema, areas as areasTableSchema, areaDevices as areaDevicesTableSchema } from '@fusion-bridge/shared';

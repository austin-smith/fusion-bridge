...
import { db, connectors } from '@fusion-bridge/shared';
import { eq, and } from 'drizzle-orm';
import * as eventsRepository from '@fusion-bridge/shared';
...
import { updateConnectorConfig } from '@fusion-bridge/shared'; // <-- IMPORT ADDED

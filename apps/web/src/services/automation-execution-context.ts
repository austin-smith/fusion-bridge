...
import { db, automations, automationExecutions, automationActionExecutions, connectors, devices, cameraAssociations, areas, areaDevices } from '@fusion-bridge/shared';

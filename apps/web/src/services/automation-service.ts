...
import { db, automations, connectors, devices, cameraAssociations, areas, areaDevices, locations, automationExecutions, automationActionExecutions } from '@fusion-bridge/shared';
...
import { findEventsInWindow, type FindEventsFilter } from '@fusion-bridge/shared';
...
import { getPushoverConfiguration } from '@fusion-bridge/shared';
...
async function evaluateTemporalCondition(
    ...
    const repoFilter: FindEventsFilter = {
